...
export default class Wheel extends React.Component {
  ...
  render() {
    ...
    {/* </div> */}
         <Button  variant="contained" color="success"  className="text-center p-5 underline font-bold text-xl tracking-widest"   onClick={this.selectItem} >סובב עכשיו</Button> 
        {/* className="text-center p-5 underline font-bold text-xl tracking-widest"   onClick={this.selectItem}*/}
